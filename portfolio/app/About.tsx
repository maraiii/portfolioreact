...
const About = () => {
  return (
    <section className="w-full relative bg-[#1f1f1f] overflow-x-hidden overflow-y-hidden">
      ...
      <div className="relative container my-16">
        ...
        <div className="relative flex justify-around text-white rounded-lg shadow-lg items-center">
          {/* Conteúdo do Card */}
          <div
            className="border-2 border-text2 p-12 flex flex-col lg:flex-row gap-8"
            style={{
